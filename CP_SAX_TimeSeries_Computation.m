...
%
%------------------------------------------------------------------------------------%
function [sax_stringSD] = CP_SAX_TimeSeries_Computation(data,nseg,alphabet_size, union_arr)
...
str = CP_Timeseries_To_symbol(data, data_len, nseg, alphabet_size, union_arr);
