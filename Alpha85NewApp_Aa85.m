function alpha85App = Alpha85NewApp_Aa85(nnseq)
data1 = xlsread('TRAIN85');    %ECG
dataT=data1(:,2:end);
%dataT
...
%xlswrite('SAlpha85.xlsx',Res_85New);
%xlswrite('Res_85NewMax.xlsx',max(Res_85New));
%mode(Res_85New)
